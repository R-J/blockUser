...
class BlockUserProfileController extends BlockUserPlugin {
    public function simpleDispatch($sender) {
...
// redirect to page
     ...
     * @return void.
     */
   public function addBlockUserButton($sender) {
    ...
    public function addEditMenuEntry($sender) {
